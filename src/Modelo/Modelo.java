...
public class Modelo {
    ...
    public boolean esNumerico(String texto) { //Declaramos el método de tipo boolean al cual le pasamos como parámetro una cadena de texto
        ...
        /**
         * *Encerramos dentro de bloque try catch para atrapar la excepción en
         * caso de que la conversión de la cadena a número falle**
         */
        try {
        ...
        return resultado;
        /**
         * *Nos devuelve el resultado, sea falso o verdadero**
         */
    }
